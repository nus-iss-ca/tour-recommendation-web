		...
		locations
				.put("SAM",
						new Location(
								...
								"1000 - 1815", "/Pics/Singapore Arts Museum.PNG"));
		locations
				.put("ASM",
						new Location(
								2,
								...
								"1000-1800 daily", "/Pics/ArtsScience Museum.PNG"));
		locations
				.put("ORC",
						new Location(
								3,
								...
								"1100-2200", "/Pics/Orchard Road.PNG"));
		locations
				.put("BUG",
						new Location(
								4,
								...
								"1100-2200 daily", "/Pics/Bugis Street.PNG"));
		locations
				.put("MUS",
						new Location(
								5,
								...
								"0000-2400 daily", "/Pics/Mustafa.PNG"));
		locations
				.put("SEN",
						new Location(
								6,
		...
		locations
				.put("GBB",
						new Location(
								...
								"0900-2100 daily", "/Pics/Gardens by the Bay.PNG"));
		locations
				.put("SGF",
						new Location(
								9,
		...
		locations
				.put("MER",
						new Location(
								...
								"0000-2400 (daily)", "/Pics/Merlion Park.PNG"));
		locations
				.put("ZOO",
						new Location(
								11,
		...
		locations
				.put("BOT",
						new Location(
								...
								"0500-2400", "/Pics/Botanic Garden.PNG"));
		locations
				.put("STJ",
						new Location(
								14,
								...
								"/Pics/St James Power Station.PNG"));
		locations
				.put("ZOK",
						new Location(
								15,
		...
		locations
				.put("TBR",
						new Location(
								...
								"Toa Payoh is HDB’s second satellite town. Formerly a swampland, initial resistance from squatters to clearance works delayed development for the town by two years. Squatters began moving out in 1962 with actual site preparation in 1964, and in time for HDB's second five-year building programme in 1965.The town was developed based on the ‘Neighbourhood Principle’, which groups several neighbourhoods around a Town Centre. The town centre acts as a focal point for the entertainment and shopping needs of residents. ",
								"http://www.hdb.gov.sg/fi10/fi10320p.nsf/w/AboutUsTownToaPayoh",
								"0500-2400", "/Pics/Tiong Bahru.PNG"));
		locations
				.put("KPG",
						new Location(
								19,
								...
								"0500-2400", "/Pics/Kampong Glam.PNG"));
		locations
				.put("CHT",
						new Location(
								20,
		...
		locations
				.put("LTI",
						new Location(
								...
								"0500-2400", "/Pics/Little India.PNG"));
		locations
				.put("CGM",
						new Location(
								22,
